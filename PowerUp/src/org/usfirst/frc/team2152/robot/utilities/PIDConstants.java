...
public class PIDConstants {
	...
	// Pre-Canned Turn
	public final static double PCT_Kp                     = 0.01;//0.013;
	public final static double PCT_Ki                     = 0.0001; //0.00005775;   
	public final static double PCT_Kd                     = 0.03; // 0.048;
	public final static double PCT_Kldiff                 = 0.0; //0.4;
    public final static double PCT_Krdiff                 = -0.0; //-0.4;
	...
	// Cube Acquire Turn
	public final static double CAT_Kp                     = 0.01; //0.005;
	public final static double CAT_Ki                     = 0.000057;//0.000057;   
	public final static double CAT_Kd                     = 0.05;//0.048;
	...
	// Cube Acquire Drive
	public static final double CAD_kP           = 0.025; //0.0125
	public static final double CAD_kI           = 0.0000;
	public static final double CAD_kD           = 0.048; // 0.048
