...
public class SwitchLeft extends CommandGroup {
	...
	public SwitchLeft() {
		...
		if (switchPosition.equals("Left")) {
			...
			//
			// addSequential(new
			// MoveByEncoder(45,45,PIDConstants.ENCODER_DRIVE_SPEED,false));
			//
			// addSequential(new PreCannedTurn(-45 - 5, true));
			// addSequential(new Delay(0.5));
			// addSequential(new
			// MoveByEncoder(75,75,PIDConstants.ENCODER_DRIVE_SPEED,false));
			//
			// addSequential(new PreCannedTurn(-85,false));
			//
			// addSequential(new
			// MoveByEncoder(35,35,PIDConstants.ENCODER_DRIVE_SPEED,false, 2));
