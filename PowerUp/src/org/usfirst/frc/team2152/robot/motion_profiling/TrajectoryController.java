...
public class TrajectoryController {
	...
	public void configureFollow() {
		...
		left.configureEncoder((driveTrain.getLSensorPosition()), TICKS_PER_REVOLUTION, WHEEL_DIAMETER);

		right.configureEncoder((driveTrain.getRSensorPosition()), TICKS_PER_REVOLUTION, WHEEL_DIAMETER);
	...
	private void followTrajectory() {
		...
		double l = left.calculate((driveTrain.getLSensorPosition()));
		double r = right.calculate((driveTrain.getRSensorPosition()));
		
		double currentHeading = -Robot.navxSubsystem.getAHRS().getYaw();
